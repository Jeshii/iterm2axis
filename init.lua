...
axis._winWatcher:subscribe(hs.window.filter.windowCreated, function()
    hs.timer.doAfter(0.3, function()
        axis.buildSidebar()
        axis.tileITermWindows()
    end)
end)
axis._winWatcher:subscribe(hs.window.filter.windowDestroyed, function()
    hs.timer.doAfter(0.3, function()
        axis.buildSidebar()
    end)
end)
axis._winWatcher:subscribe(hs.window.filter.windowTitleChanged, function()
