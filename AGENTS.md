...
- `iTerm2Axis.spoon/init.lua` — Entry point, OBJ scaffolding, config, constants, bindHotkeys/start/stop/init
- `iTerm2Axis.spoon/cache.lua` — CACHE table, window cache, parse helpers
- `iTerm2Axis.spoon/flash.lua` — Flash state machine for Claude Code / bell alerts
- `iTerm2Axis.spoon/fetchers.lua` — Window info fetching, git branch, opencode/Claude polling
- `iTerm2Axis.spoon/render.lua` — Sidebar canvas rendering, button layout, text rows
- `iTerm2Axis.spoon/windows.lua` — Layout, tiling, window move/focus, sidebar toggle
- `iTerm2Axis.spoon/mouse.lua` — Click/drag handling, context menus
- `iTerm2Axis.spoon/watchers.lua` — Window/app/screen/space event watchers
...
- All edits go into files under `iTerm2Axis.spoon/`. The user handles deployment
